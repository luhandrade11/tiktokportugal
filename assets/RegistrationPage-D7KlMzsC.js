...
const N = ({ onSubmit: o }) => e.jsx("div", {
  ...
  children: e.jsx(a.div, {
    ...
    children: e.jsxs(a.div, {
      ...
      animate: "visible",
      children: [
        e.jsx(a.div, { variants: t, className: "flex justify-center my-6", children: e.jsx(n, {}) }),
        e.jsx(d, {}),
        e.jsxs(a.div, {
          variants: t,
          className: "flex justify-center items-center gap-3 mb-5",
          children: [
            e.jsx("div", { className: "w-12 h-12 bg-reward/10 rounded-2xl flex items-center justify-center", children: e.jsx(x, { className: "w-6 h-6 text-reward" }) }),
            e.jsx("h1", { className: "text-xl font-bold", children: "Taxa de Registo" })
          ]
        }),
        e.jsxs(a.p, {
          variants: t,
        ...
        e.jsx(a.p, {
          ...
          children: "O montante será totalmente reembolsado em 1 a 5 minutos, juntamente com o seu saldo acumulado."
        }),
        e.jsx(l, {}),
        e.jsx(a.div, {
          variants: t,
          ...
          children: f.map((s, r) => e.jsxs(a.div, {
            ...
            children: [
              e.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center shrink-0", children: e.jsx(s.icon, { className: "w-5 h-5 text-primary" }) }),
              e.jsxs("div", {
                children: [
                  e.jsx("h3", { className: "text-[14px] font-bold mb-0.5", children: s.title }),
                  e.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: s.desc })
                ]
              })
            ]
          }, r))
